...
source /var/www/NicerAppWebOS-v6.y.z/domains/nicer.app/NicerAppWebOS/scripts.maintenance/do_upgrade_globals_manufacturer.sh
NA_ROOT_PATH="$NA_MAIN_HTDOCS_RELATIVE_PATH/$NA_MAIN_SITE_FOLDER"
if [ ! -d $NA_ROOT_PATH ]; then
        NA_ROOT_PATH="/var/www/NicerAppWebOS-v6.y.z/"
fi
